...
| Project | What It Does | Tech |
|---------|-------------|------|
| [**google-meet-transcriber**](https://github.com/Atharv279/google-meet-transcriber) | Captures and saves real-time transcript data from Google Meet | Rust |
| [**Advanced_Gemini_QA_Bot**](https://github.com/Atharv279/Advanced_Gemini_QA_Bot) | Interactive Q&A chatbot with chat history using Gemini Pro | Python, Streamlit, Gemini |
